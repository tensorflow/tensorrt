...
RUN_ARGS="--data_dir=/data/c4 --input_saved_model_dir=/models/huggingface/t5 --tokenizer_model_dir=/models/huggingface/t5 --dataset_name=realnewslike --debug --batch_size=32 --display_every=1"
